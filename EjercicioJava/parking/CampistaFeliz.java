...
import parking.Camping;

// TODO: Auto-generated Javadoc
/**
 * Clase Campista Feliz la cual tiene el metodo main y permite gestionar las caravanas y las personas de los diferentes campings
 */
public class CampistaFeliz {
	

	static Camping listaCampings[];
	...
	private static void crearCamping() throws IOException{
		String nombre;
		double CIF,precio;
		int cantidadPlazas,cantidadCampings;
		...
		for (int i=0;i<cantidadCampings;i++){
			...
			listaCampings[i]= new Camping(CIF,nombre,cantidadPlazas);
